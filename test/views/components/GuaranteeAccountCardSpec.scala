...
import domain.{
  AccountCancelled, AccountStatusClosed, AccountStatusOpen, AccountStatusSuspended, DefermentAccountAvailable,
  DirectDebitMandateCancelled, GeneralGuaranteeAccount, GeneralGuaranteeBalance
}
