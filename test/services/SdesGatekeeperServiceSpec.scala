...
import domain.{Metadata, MetadataItem, PostponedVatStatementFile, PostponedVatStatementFileMetadata, SecurityStatementFile, SecurityStatementFileMetadata, StandingAuthorityFile, StandingAuthorityFileMetadata, VatCertificateFile, VatCertificateFileMetadata}
  ...
  "SdesGatekeeperService" should {
    ...
    "create StandingAuthorityFile from FileInformation" in  {
      ...
      val expectedStandingAuthorityFile = StandingAuthorityFile(
        ...
        "https://some.sdes.domain?token=abc123",
        1234L,
        StandingAuthorityFileMetadata(2022, 6, 1, Csv, StandingAuthority), ""
      )
