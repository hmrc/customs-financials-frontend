...
cf.account.status.aria.AccountStatusSuspended=Mae angen cymryd camau pellach ar gyfer y cyfrif hwn
...
cf.not-subscribed-to-cds.detail.how-to-get-access-info=Os ydych eisoes wedi tanysgrifio i’r CDS
cf.not-subscribed-to-cds.detail.process-application-info=Gwiriwch eich bod wedi mewngofnodi gyda’r Dynodydd Defnyddiwr (ID) ar gyfer Porth y Llywodraeth sy’n gysylltiedig â’ch Rhif Cofrestru ac Adnabod Gweithredwyr Economaidd (EORI) a’ch cyfrif CDS.
...
cf.authorities.notification-panel.p2=Crëwyd eich rhestr ar 19 Awst 2022. Bydd ar gael i’w gweld am 10 diwrnod.
