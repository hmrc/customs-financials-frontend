...
cf.not-subscribed-to-cds.detail.list-item.2=rydych wedi mewngofnodi gan ddefnyddio’r Dynodydd Defnyddiwr (ID) anghywir ar gyfer Porth y Llywodraeth - gwnewch yn siŵr eich bod yn defnyddio’r un sy’n gysylltiedig â’ch rhif EORI
...
cf.customs-financials-home.notification.requested-cash-statement=Mae’r trafodion cyfrif arian parod y gwnaethoch gais amdanynt yn barod i’w gweld.
...
cf.duty-deferment.account.card.guarantee.limit.remaining.dl=Y warant sy’n weddill:
