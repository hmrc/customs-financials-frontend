...
import uk.gov.hmrc.customs.financials.domain.DDStatementType.{Excise, Supplementary}
import uk.gov.hmrc.customs.financials.domain.{DDStatementType, DutyDefermentStatementFile, FileFormat, FileRole}
...
case class DutyDefermentStatementPeriod(fileRole: FileRole,
  ...
  import uk.gov.hmrc.customs.financials.services.DateConverters.OrderedLocalDate
