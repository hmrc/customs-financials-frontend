...
import domain.FileFormat.{SdesFileFormats, authorityFileFormats, filterFileFormats}
import domain.FileRole.StandingAuthority
import domain.StandingAuthorityFile
import domain.{FileInformation, SdesFile, VatCertificateFile}
...
class SdesConnector @Inject()(httpClient: HttpClient,
  ...
  def getCsvFiles(eori: String)(implicit hc: HeaderCarrier, messages: Messages): Future[Seq[StandingAuthorityFile]] = {
